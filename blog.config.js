...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1a1962f50f0880ad903ec5231ed62472,en:1a1962f50f0880ad903ec5231ed62472',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'FengHao', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '简单生活，深刻思考', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://fhcy.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'FHCY, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.png', // blog favicon 配置, 默认使用 /public/，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '渝ICP备19008263号', // 备案号 闽ICP备XXXXXX
